      ...
      items: [
        {
          id: 1,
          image: img1,
          title: "Jennifer Shapiro",
          subtitle: "Frontend",
          desc: "The European languages are members of the same family Their separate existence is a myth For science, music, sport, etc, europe their languages common words.",
        },
        {
          id: 2,
          image: img2,
          title: "Brandon Carney",
          subtitle: "Designer",
          desc: "The European languages are members of the same family Their separate existence is a myth For science, music, sport, etc, europe their languages common words.",
        },
        {
    ...
    if (indicators.length) {
      this.state.items.forEach((item, index) => {
        if (indicators[index]) {
          ...
          img.src = item.image;
          indicators[index].appendChild(img);
        }
      });
    }
  }
